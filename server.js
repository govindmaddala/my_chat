...
const { dbConnect } = require('./node/database/connectDatabase.js');
const { ErrorHandler } = require('./node/middleware/ErrorHandler.js');
const { PathNotFound } = require('./node/middleware/PathNotFound.js');
app.use(bodyParser.urlencoded({ extended: true }));
app.use(bodyParser.json());
app.use(cors());

var morgan = require('morgan');
const ErrorHandle = require('./node/utilities/ErrorHandle.js');
const UserModel = require('./node/models/UserModel.js');
const { CatchAsyncErrors } = require('./node/utilities/CatchAsyncErrors.js');
const LogsModel = require('./node/models/LogsModel.js');
app.use(morgan('dev'))
...
app.use('/api/users', require('./node/routes/users.routes.js'))
app.use('/api/chats', require('./node/routes/chats.routes.js'))
app.use('/api/messages', require('./node/routes/messages.routes.js'))
